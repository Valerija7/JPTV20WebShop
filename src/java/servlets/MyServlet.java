...
public class MyServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        List<Product> modelsList = modelFacade.findAll();
        ...
        switch (path) {
            ...
            case "/showEditModel":
                ...
                break;
            case "/editModel":
               Product editModel = modelFacade.find(Long.parseLong(request.getParameter("theModels")));
            ...
            case "/showDeleteModel":
                ...
                break;
            case "/deleteModel":
                Product deleteModel = modelFacade.find(Long.parseLong(request.getParameter("TheModels")));
                ...
                try {
                    ...
                    for (History history : histories) {
                        if(Objects.equals(deleteModel.getId(), history.getProduct().getId())) {
            ...
            case "/showBuyModel":
                ...
                break;
            case "/buyModel":
                Product buyModel = modelFacade.find(Long.parseLong(request.getParameter("buyModels")));
