    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        switch(path) {
            ...
            case "/showEditUser":
                ...
                request.setAttribute("sureName", authUser.getLastName());
            ...
            case "/addMoney":
                ...
                authUser.setMoney(authUser.getMoney() + Double.parseDouble(moneyToAdd));
                userFacade.edit(authUser);
            ...
            case "/showBuyProduct":
                ...
                request.setAttribute("wallet", authUser.getMoney());
            ...
            case "/buyProduct":
                ...
                if (authUser.getMoney() >= product.getPrice()) {
                    history.setProduct(product);
                    history.setUser(authUser);
                    history.setPurchaseDate(localdateToDate(LocalDate.now()));
                    historyFacade.edit(history);
                    authUser.setMoney(authUser.getMoney() - product.getPrice());
                    userFacade.edit(authUser);
