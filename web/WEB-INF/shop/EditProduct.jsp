    ...
    <form action="editProduct?id=${id}" method="POST" >
        <div class="card border-0 mb-3 px-3" style="width: 40em;">
            ...
            <div class="form-group">
                ...
                <input type="number" min="31" max="48" class="form-control" name="size">
            </div>
            <div class="form-group">
                ...
                <div class="form-group">
                    <div class="input-group">
                        ...
                        <input type="number" min="1.00" step="0.01" name="price" class="form-control" >
                    </div>
                </div>
            </div>
            <div class="form-group">
                <label class="form-label mt-2 mx-2">Количество</label>
                <input type="number" min="1" class="form-control mb-4" name="quantity">
            </div>
